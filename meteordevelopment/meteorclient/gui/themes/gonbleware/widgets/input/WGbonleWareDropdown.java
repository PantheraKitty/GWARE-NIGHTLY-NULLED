...
public class WGbonleWareDropdown<T> extends WDropdown<T> implements GonbleWareWidget {
   ...
   protected WDropdown.WDropdownRoot createRootWidget() {
      return new WGbonleWareDropdown.WRoot();
   }

   protected WDropdown<T>.WDropdownValue createValueWidget() {
      return new WGbonleWareDropdown.WValue(this);
   }
   ...
   private static class WRoot extends WDropdown.WDropdownRoot implements GonbleWareWidget {
      protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
         GonbleWareGuiTheme theme = this.theme();
   ...
   private class WValue extends WDropdown<T>.WDropdownValue implements GonbleWareWidget {
      private WValue(final WGbonleWareDropdown param1) {
         super();
      }
