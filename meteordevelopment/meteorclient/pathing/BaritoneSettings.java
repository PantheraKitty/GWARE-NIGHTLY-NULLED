...
public class BaritoneSettings implements IPathManager.ISettings {
   ...
   private void createWrappers() {
      ...
      try {
         ...
         Field[] var9 = klass.getDeclaredFields();
            ...
            if (!Modifier.isStatic(field.getModifiers())) {
               ...
               if (obj instanceof baritone.api.Settings.Setting) {
                  ...
                  if (value instanceof Boolean) {
                     wrapper = sgBool.add(((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)(new BoolSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue((Boolean)setting.defaultValue)).onChanged((aBoolean) -> {
                        setting.value = aBoolean;
                     })).onModuleActivated((booleanSetting) -> {
                        booleanSetting.set((Boolean)setting.value);
                     })).build());
                     String var17 = wrapper.name;
                     byte var18 = -1;
                     switch(var17.hashCode()) {
                     case -1045892200:
                        if (var17.equals("assumeStep")) {
                           var18 = 2;
                        }
                        break;
                     case 39154772:
                        if (var17.equals("assumeWalkOnLava")) {
                           var18 = 1;
                        }
                        break;
                     case 1223954979:
                        if (var17.equals("assumeWalkOnWater")) {
                           var18 = 0;
                        }
                     }
                     ...
                     sgDouble.add(((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)(new DoubleSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue((Double)setting.defaultValue).max((Double)SETTING_MAX_VALUES.getOrDefault(setting.getName(), 10.0D)).sliderMax((Double)SETTING_MAX_VALUES.getOrDefault(setting.getName(), 10.0D)).onChanged((aDouble) -> {
                        setting.value = aDouble;
                     })).onModuleActivated((doubleSetting) -> {
                        doubleSetting.set((Double)setting.value);
                     })).build());
                  } else if (value instanceof Float) {
                     sgDouble.add(((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)(new DoubleSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue(((Float)setting.defaultValue).doubleValue()).max((Double)SETTING_MAX_VALUES.getOrDefault(setting.getName(), 10.0D)).sliderMax((Double)SETTING_MAX_VALUES.getOrDefault(setting.getName(), 10.0D)).onChanged((aDouble) -> {
                        setting.value = aDouble.floatValue();
                     })).onModuleActivated((doubleSetting) -> {
                        doubleSetting.set(((Float)setting.value).doubleValue());
                     })).build());
                  } else if (value instanceof Integer) {
                     wrapper = sgInt.add(((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)(new IntSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue((Integer)setting.defaultValue)).onChanged((integer) -> {
                     ...
                     if (wrapper.name.equals("maxFallHeightNoWater")) {
                        this.noFall = ((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)(new BoolSetting.Builder()).name(wrapper.name)).description(wrapper.description)).defaultValue(false)).onChanged((aBoolean) -> {
                           wrapper.set(aBoolean ? 159159 : (Integer)wrapper.getDefaultValue());
                        })).onModuleActivated((booleanSetting) -> {
                           booleanSetting.set((Integer)wrapper.get() >= 255);
                        })).build();
                     }
                  } else if (value instanceof Long) {
                     sgInt.add(((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)(new IntSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue(((Long)setting.defaultValue).intValue())).onChanged((integer) -> {
                        setting.value = integer.longValue();
                     })).onModuleActivated((integerSetting) -> {
                        integerSetting.set(((Long)setting.value).intValue());
                     })).build());
                  } else if (value instanceof String) {
                     sgString.add(((StringSetting.Builder)((StringSetting.Builder)((StringSetting.Builder)((StringSetting.Builder)((StringSetting.Builder)(new StringSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue((String)setting.defaultValue)).onChanged((string) -> {
                        setting.value = string;
                     })).onModuleActivated((stringSetting) -> {
                        stringSetting.set((String)setting.value);
                     })).build());
                  } else if (value instanceof Color) {
                     Color c = (Color)setting.value;
                     sgColor.add(((ColorSetting.Builder)((ColorSetting.Builder)((ColorSetting.Builder)((ColorSetting.Builder)(new ColorSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue(new SettingColor(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha())).onChanged((color) -> {
                     ...
                     if (type == class_2248.class) {
                        sgBlockLists.add(((BlockListSetting.Builder)((BlockListSetting.Builder)((BlockListSetting.Builder)((BlockListSetting.Builder)((BlockListSetting.Builder)(new BlockListSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue((List)setting.defaultValue)).onChanged((blockList) -> {
                           setting.value = blockList;
                        })).onModuleActivated((blockListSetting) -> {
                           blockListSetting.set((List)setting.value);
                        })).build());
                     } else if (type == class_1792.class) {
                        sgItemLists.add(((ItemListSetting.Builder)((ItemListSetting.Builder)((ItemListSetting.Builder)((ItemListSetting.Builder)((ItemListSetting.Builder)(new ItemListSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue((List)setting.defaultValue)).onChanged((itemList) -> {
                           setting.value = itemList;
                        })).onModuleActivated((itemListSetting) -> {
                           itemListSetting.set((List)setting.value);
                        })).build());
                     }
                  }
               }
   ...
   private static String getDescription(String settingName) {
      ...
      return (String)descriptions.get(settingName.toLowerCase());
   }
   ...
   static {
      SETTING_MAX_VALUES.put("pathCutoffFactor", 1.0D);
   }
}
