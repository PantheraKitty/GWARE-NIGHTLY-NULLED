...
class CtClassType extends CtClass {
      ...
      if (cfile != null) {
         ...
         if (rcfile != null) {
            ...
            try {
               ...
               throw new RuntimeException(var22.toString(), var22);
            } finally {
               if (fin != null) {
                  try {
   ...
   private static CtMethod getMethod0(CtClass cc, String name, String desc) {
      ...
      try {
         CtClass[] ifs = cc.getInterfaces();
         CtClass[] var14 = ifs;
         int var15 = ifs.length;

         for(int var6 = 0; var6 < var15; ++var6) {
            CtClass ctc = var14[var6];
   ...
   public void instrument(CodeConverter converter) throws CannotCompileException {
      ...
      MethodInfo[] var5 = (MethodInfo[])methods.toArray(new MethodInfo[methods.size()]);
      int var6 = var5.length;

      for(int var7 = 0; var7 < var6; ++var7) {
         MethodInfo minfo = var5[var7];
   ...
   public void instrument(ExprEditor editor) throws CannotCompileException {
      ...
      ClassFile cf = this.getClassFile2();
      List<MethodInfo> methods = cf.getMethods();
      MethodInfo[] var4 = (MethodInfo[])methods.toArray(new MethodInfo[methods.size()]);
      int var5 = var4.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         MethodInfo minfo = var4[var6];
   ...
   private void modifyConstructors(ClassFile cf) throws CannotCompileException, NotFoundException {
      if (this.fieldInitializers != null) {
         ...
         while(var4.hasNext()) {
            MethodInfo minfo = (MethodInfo)var4.next();
   ...
   private void makeMemberList(Map<Object, CtClassType> table) {
      ...
      while(var12.hasNext()) {
         MethodInfo minfo = (MethodInfo)var12.next();
      ...
      while(var15.hasNext()) {
         FieldInfo finfo = (FieldInfo)var15.next();
