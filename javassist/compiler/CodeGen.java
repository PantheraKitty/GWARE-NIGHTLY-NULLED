   ...
   private void atSwitchStmnt(Stmnt st) throws CompileError {
      ...
      for(Object list = body; list != null; list = ((ASTList)list).tail()) {
         ...
         if (op == 310) {
            ...
            pairs[ipairs++] = (caseLabel << 32) + ((long)(addr - opcodePc) & -1L);
         }
      ...
      Iterator var23 = gotoDefaults.iterator();

      while(var23.hasNext()) {
         addr = (Integer)var23.next();
